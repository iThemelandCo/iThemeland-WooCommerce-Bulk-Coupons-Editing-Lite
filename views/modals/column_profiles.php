        ...
        <div class="wccbef-modal-box wccbef-modal-box-lg">
            <div class="wccbef-modal-content">
                <div class="wccbef-modal-title">
                    <h2><?php esc_html_e('Column Profiles', WCCBEF_NAME); ?></h2>
                ...
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                    ...
                    <div class="wccbef-modal-body">
                        <div class="wccbef-wrap">
                            <div class="wccbef-alert wccbef-alert-default">
                                <span><?php esc_html_e('You can load saved column profile presets through Column Manager. You can change the columns and save your changes too.', WCCBEF_NAME); ?></span>
                            </div>
                            <div class="wccbef-column-profiles-choose">
                                <label for="wccbef-column-profiles-choose"><?php esc_html_e('Choose Preset', WCCBEF_NAME); ?></label>
                    ...
                    <div class="wccbef-modal-footer">
                        <button type="submit" class="wccbef-button wccbef-button-blue wccbef-float-left" id="wccbef-column-profiles-apply" data-preset-key="<?php echo (!empty($first_key)) ? $first_key : ''; ?>">
                            <?php esc_html_e('Apply To Table', WCCBEF_NAME); ?>
                        </button>
                        <div class="wccbef-column-profile-search wccbef-float-right">
                            <label for="wccbef-column-profile-search"><?php esc_html_e('Search', WCCBEF_NAME); ?> </label>
                            <input type="text" id="wccbef-column-profile-search" placeholder="<?php esc_html_e('Search Column ...', WCCBEF_NAME); ?>">
                        </div>
                    </div>
                </form>
            </div>
