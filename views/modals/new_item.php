        ...
        <div class="wccbef-modal-box wccbef-modal-box-sm">
            <div class="wccbef-modal-content">
                ...
                <div class="wccbef-modal-body">
                    <div class="wccbef-wrap">
                        <div class="wccbef-form-group">
                            ...
                            <input type="number" class="wccbef-input-numeric-sm wccbef-m0" id="wccbef-new-item-count" value="1" placeholder="<?php esc_html_e('Number ...', WCCBEF_NAME); ?>">
                        </div>
                ...
                <div class="wccbef-modal-footer">
                    <button type="button" class="wccbef-button wccbef-button-blue" id="wccbef-create-new-item"><?php esc_html_e('Create', WCCBEF_NAME); ?></button>
                </div>
            </div>
        </div>
    </div>
