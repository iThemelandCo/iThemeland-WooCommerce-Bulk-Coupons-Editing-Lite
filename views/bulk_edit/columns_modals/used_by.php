<div class="wccbef-modal" id="wccbef-modal-used-by">
        ...
        <div class="wccbef-modal-box wccbef-modal-box-sm">
            <div class="wccbef-modal-content">
                <div class="wccbef-modal-title">
                    <h2><?php esc_html_e('Used by', WCCBEF_NAME); ?> <span id="wccbef-modal-used-by-item-title" class="wccbef-modal-item-title"></span></h2>
                ...
                <div class="wccbef-modal-body">
                    <div class="wccbef-wrap">
                        <div class="wccbef-col-full" id="wccbef-modal-coupon-used-by-items">
