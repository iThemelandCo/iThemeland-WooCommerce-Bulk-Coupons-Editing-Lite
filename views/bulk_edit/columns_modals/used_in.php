<div class="wccbef-modal" id="wccbef-modal-used-in">
        ...
        <div class="wccbef-modal-box wccbef-modal-box-sm">
            <div class="wccbef-modal-content">
                <div class="wccbef-modal-title">
                    <h2><?php esc_html_e('Used in', WCCBEF_NAME); ?> <span id="wccbef-modal-used-in-item-title" class="wccbef-modal-item-title"></span></h2>
                ...
                <div class="wccbef-modal-body">
                    <div class="wccbef-wrap">
                        <div class="wccbef-col-full" id="wccbef-modal-coupon-used-in-items">
