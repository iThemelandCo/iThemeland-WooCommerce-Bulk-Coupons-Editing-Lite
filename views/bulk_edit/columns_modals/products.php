        ...
        <div class="wccbef-modal-box wccbef-modal-box-sm">
            <div class="wccbef-modal-content">
                <div class="wccbef-modal-title">
                    <h2><?php esc_html_e('Products', WCCBEF_NAME); ?> <span id="wccbef-modal-products-item-title" class="wccbef-modal-item-title"></span></h2>
                ...
                <div class="wccbef-modal-body">
                    <div class="wccbef-wrap">
                        <div class="wccbef-col-full">
                            <label for="wccbef-modal-products-items"><strong><?php esc_html_e('Select Products', WCCBEF_NAME); ?></strong></label>
                            <select id="wccbef-modal-products-items" class="wccbef-select2-products" data-placeholder="<?php esc_html_e('Select Products', WCCBEF_NAME); ?> ..." multiple></select>
                        </div>
                    </div>
                </div>
