    ...
    <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
        ...
        <div class="wccbef-tab-middle-content">
            <div class="wccbef-alert wccbef-alert-default">
                <span><?php esc_html_e('You can set bulk editor settings', WCCBEF_NAME); ?></span>
            </div>
            ...
            <div class="wccbef-form-group">
                <label for="wccbef-settings-count-per-page"><?php esc_html_e('Count Per Page', WCCBEF_NAME); ?></label>
            ...
            <div class="wccbef-form-group">
                <label for="wccbef-settings-default-sort-by"><?php esc_html_e('Default Sort By', WCCBEF_NAME); ?></label>
            ...
            <div class="wccbef-form-group">
                <label for="wccbef-settings-default-sort"><?php esc_html_e('Default Sort', WCCBEF_NAME); ?></label>
                <select name="settings[default_sort]" id="wccbef-settings-default-sort" class="wccbef-input-md">
                    <option value="ASC" <?php echo (isset($settings['default_sort']) && $settings['default_sort'] == 'ASC') ? 'selected' : ''; ?>>
                        <?php esc_html_e('ASC', WCCBEF_NAME); ?>
                    </option>
                    <option value="DESC" <?php echo (isset($settings['default_sort']) && $settings['default_sort'] == 'DESC') ? 'selected' : ''; ?>>
                        <?php esc_html_e('DESC', WCCBEF_NAME); ?>
                    </option>
                </select>
            </div>
            <div class="wccbef-form-group">
                <label for="wccbef-settings-show-quick-search"><?php esc_html_e('Show Quick Search', WCCBEF_NAME); ?></label>
                <select name="settings[show_quick_search]" id="wccbef-settings-show-quick-search" class="wccbef-input-md">
                    <option value="yes" <?php echo (isset($settings['show_quick_search']) && $settings['show_quick_search'] == 'yes') ? 'selected' : ''; ?>>
                        <?php esc_html_e('Yes', WCCBEF_NAME); ?>
                    </option>
                    <option value="no" <?php echo (isset($settings['show_quick_search']) && $settings['show_quick_search'] == 'no') ? 'selected' : ''; ?>>
                        <?php esc_html_e('No', WCCBEF_NAME); ?>
                    </option>
                </select>
            </div>
            <div class="wccbef-form-group">
                <label for="wccbef-settings-sticky-search-form"><?php esc_html_e('Search Form Mode', WCCBEF_NAME); ?></label>
                <select name="settings[sticky_search_form]" id="wccbef-settings-sticky-search-form" class="wccbef-input-md">
                    <option value="yes" <?php echo (isset($settings['sticky_search_form']) && $settings['sticky_search_form'] == 'yes') ? 'selected' : ''; ?>>
                        <?php esc_html_e('Don\'t Push Down the Content', WCCBEF_NAME); ?>
                    </option>
                    <option value="no" <?php echo (isset($settings['sticky_search_form']) && $settings['sticky_search_form'] == 'no') ? 'selected' : ''; ?>>
                        <?php esc_html_e('Push Down the Content', WCCBEF_NAME); ?>
                    </option>
                </select>
            </div>
            <div class="wccbef-form-group">
                <label for="wccbef-settings-sticky-first-columns"><?php esc_html_e("Sticky 'ID & Title' Columns", WCCBEF_NAME); ?></label>
            ...
            <div class="wccbef-form-group">
                <label for="wccbef-settings-display-full-columns-title"><?php esc_html_e('Display Columns Label', WCCBEF_NAME); ?></label>
        ...
        <div class="wccbef-tab-footer">
            <div class="wccbef-tab-footer-left">
                <button type="submit" class="wccbef-button wccbef-button-lg wccbef-button-blue">
                    ...
                    <span><?php esc_html_e('Save Changes', WCCBEF_NAME); ?></span>
                </button>
            </div>
            <div class="clear"></div>
        </div>
