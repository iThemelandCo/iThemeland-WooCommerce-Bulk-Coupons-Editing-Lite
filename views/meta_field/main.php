<div class="wccbef-wrap">
    <div class="wccbef-tab-middle-content">
        <div class="wccbef-alert wccbef-alert-default">
            <span><?php esc_html_e('You can add new coupons meta fields in two ways: 1- Individually 2- Get from other coupon.', WCCBEF_NAME); ?></span>
        </div>
        ...
        <div class="wccbef-meta-fields-left">
            <div class="wccbef-meta-fields-manual">
                <label for="wccbef-meta-fields-manual_key_name"><?php esc_html_e('Manually', WCCBEF_NAME); ?></label>
                <div class="wccbef-meta-fields-manual-field">
                    <input type="text" id="wccbef-meta-fields-manual_key_name" placeholder="<?php esc_html_e('Enter Meta Key ...', WCCBEF_NAME); ?>">
            ...
            <div class="wccbef-meta-fields-automatic">
                <label for="wccbef-add-meta-fields-coupon-id"><?php esc_html_e('Automatically From Coupon', WCCBEF_NAME); ?></label>
                <div class="wccbef-meta-fields-automatic-field">
                    <input type="text" id="wccbef-add-meta-fields-coupon-id" placeholder="<?php esc_html_e('Enter Coupon ID ...', WCCBEF_NAME); ?>">
        ...
        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
            ...
            <div class="wccbef-meta-fields-right" id="wccbef-meta-fields-items">
                <p class="wccbef-meta-fields-empty-text" <?php echo (!empty($meta_fields)) ? 'style="display:none";' : ''; ?>><?php esc_html_e("Please add your meta key manually", WCCBEF_NAME); ?><br> <?php esc_html_e("OR", WCCBEF_NAME); ?><br><?php esc_html_e("From another coupon", WCCBEF_NAME); ?></p>
            ...
            <div class="wccbef-meta-fields-buttons">
                <div class="wccbef-meta-fields-buttons-left">
                    <button type="submit" value="1" name="save_meta_fields" class="wccbef-button wccbef-button-lg wccbef-button-blue">
                        ...
                        <span><?php esc_html_e('Save Fields', WCCBEF_NAME); ?></span>
                    </button>
                </div>
            </div>
        </form>
