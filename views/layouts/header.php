<div id="wccbef-main">
    <div id="wccbef-loading" class="wccbef-loading">
        <?php esc_html_e('Loading ...', WCCBEF_NAME) ?>
    </div>
    <div id="wccbef-header">
        <div class="wccbef-plugin-title">
            ...
            <span class="wccbef-plugin-description"><?php esc_html_e("Be professionals with managing data in the reliable and flexible way!", WCCBEF_NAME); ?></span>
        </div>
        <div class="wccbef-header-left">
            <div class="wccbef-plugin-help">
                <span>
                    <a href="<?php echo (!empty($doc_link)) ? esc_attr($doc_link) : '#'; ?>"><strong class="wccbef-plugin-help-text"><?php esc_html_e('Need Help', WCCBEF_NAME); ?></strong> <i class="lni-help"></i></a>
                </span>
            </div>
