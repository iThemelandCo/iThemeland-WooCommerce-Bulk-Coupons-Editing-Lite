jQuery(document).ready(function ($) {
    ...
    $(document).on('click', '#wccbef-activation-activate', function () {
        $('#wccbef-activation-type').val('activate');

        if ($('#wccbef-activation-email').val() != '') {
            if ($('#wccbef-activation-industry').val() != '') {
                setTimeout(function () {
                    $('#wccbef-activation-form').first().submit();
                }, 200)
            } else {
                swal({
    ...
    $(document).on('click', '#wccbef-activation-skip', function () {
        $('#wccbef-activation-type').val('skip');
