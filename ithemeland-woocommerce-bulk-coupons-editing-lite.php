...
define('WCCBEF_NAME', 'ithemeland-woocommerce-bulk-coupons-editing-lite');
define('WCCBEF_LABEL', 'Ithemeland Woocommerce Bulk Coupons Editing Lite');
define('WCCBEF_CORE_PLUGIN', 'ithemeland-bulk-bundle-core/ithemeland-bulk-bundle-core.php');
...
define('WCCBEF_LANGUAGES_DIR', dirname(plugin_basename(__FILE__)) . '/languages/');
...
define('WCCBEF_VERSION', '1.7');
define('WCCBEF_UPGRADE_URL', 'https://ithemelandco.com/plugins/woocommerce-bulk-coupons-editing?utm_source=free_plugins&utm_medium=plugin_links&utm_campaign=user-lite-buy');
