...
use wccbef\classes\bootstrap\WCCBEF_Verification;
...
class Woo_Coupon_Controller
{
    ...
    public function index()
    {
        ...
        $is_active = WCCBEF_Verification::is_active();
        $activation_skipped = WCCBEF_Verification::skipped();
        $title = esc_html__('WooCommerce Bulk Coupons Editing', WCCBEF_NAME);
        $doc_link = "https://ithemelandco.com/Plugins/Documentations/Pro-Bulk-Editing/woocommerce-bulk-coupons-editing/documentation.pdf";
