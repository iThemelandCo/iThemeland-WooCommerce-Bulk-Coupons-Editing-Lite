...
class Column
{
    ...
    public static function get_static_columns()
    {
        return [
            'post_title' => [
                'field' => 'post_title',
                'title' => esc_attr__('Title', WCCBEF_NAME)
            ]
        ];
    }
    ...
    public function get_fields()
    {
        ...
        return apply_filters('wccbef_column_fields', [
            'post_excerpt' => [
                'label' => esc_html__('Description', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'text',
                'field_type' => 'general'
            ...
            'post_date' => [
                'label' => esc_html__('Published on', WCCBEF_NAME),
                'editable' => true,
                'sortable' => true,
            ...
            'post_modified' => [
                'label' => esc_html__('Modification date', WCCBEF_NAME),
                'editable' => false,
                'sortable' => true,
                'content_type' => 'date',
                'field_type' => 'general'
            ...
            'date_expires' => [
                'label' => esc_html__('Coupon expiry date', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'date',
                'field_type' => 'general'
            ...
            'product_ids' => [
                'label' => esc_html__('Products', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
            ...
            'exclude_product_ids' => [
                'label' => esc_html__('Exclude products', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'products',
                'field_type' => 'usage_restriction'
            ...
            'product_categories' => [
                'label' => esc_html__('Product categories', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
            ...
            'exclude_product_categories' => [
                'label' => esc_html__('Exclude categories', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'product_categories',
                'field_type' => 'usage_restriction'
            ...
            'coupon_amount' => [
                'label' => esc_html__('Coupon amount', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
            ...
            'minimum_amount' => [
                'label' => esc_html__('Minimum spend', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'numeric',
                'field_type' => 'usage_restriction'
            ...
            'maximum_amount' => [
                'label' => esc_html__('Maximum spend', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'numeric',
                'field_type' => 'usage_restriction'
            ...
            'usage_limit' => [
                'label' => esc_html__('Usage limit per coupon', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'numeric',
            ...
            'usage_limit_per_user' => [
                'label' => esc_html__('Usage limit per user', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'numeric',
                'field_type' => 'usage_limits'
            ...
            'limit_usage_to_x_items' => [
                'label' => esc_html__('Usage limit to x items', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'numeric',
                'field_type' => 'usage_limits'
            ...
            'discount_type' => [
                'label' => esc_html__('Discount type', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'select',
            ...
            'post_status' => [
                'label' => esc_html__('Status', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'select',
            ...
            'free_shipping' => [
                'label' => esc_html__('Allow free shipping', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
            ...
            'individual_use' => [
                'label' => esc_html__('Individual use only', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'checkbox_dual_mode',
                'field_type' => 'usage_restriction'
            ...
            'exclude_sale_items' => [
                'label' => esc_html__('Exclude sale items', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'checkbox_dual_mode',
                'field_type' => 'usage_restriction'
            ...
            'customer_email' => [
                'label' => esc_html__('Allowed Emails', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'text',
                'field_type' => 'usage_restriction'
            ...
            'usage_count' => [
                'label' => esc_html__('Usage count', WCCBEF_NAME),
                'editable' => false,
                'sortable' => false,
                'content_type' => 'text',
                'field_type' => 'general'
            ...
            '_used_by' => [
                'label' => esc_html__('Used by', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
            ...
            'used_in' => [
                'label' => esc_html__('Used in', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
    ...
    public static function get_default_columns_default()
    {
        ...
        return [
            ...
            'coupon_amount' => [
                'label' => esc_html__('Coupon amount', WCCBEF_NAME),
                'title' => esc_html__('Coupon amount', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'numeric',
                'field_type' => 'general',
            ...
            'post_excerpt' => [
                'label' => esc_html__('Description', WCCBEF_NAME),
                'title' => esc_html__('Description', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'text',
                'field_type' => 'general',
            ...
            'product_ids' => [
                'label' => esc_html__('Products', WCCBEF_NAME),
                'title' => esc_html__('Products', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'products',
                'field_type' => 'usage_restriction',
            ...
            'usage_limit' => [
                'label' => esc_html__('Usage limit per coupon', WCCBEF_NAME),
                'title' => esc_html__('Usage limit per coupon', WCCBEF_NAME),
                'editable' => true,
                'sortable' => false,
                'content_type' => 'numeric',
                'field_type' => 'usage_limits',
            ...
            'date_expires' => [
                'label' => esc_html__('Coupon expiry date', WCCBEF_NAME),
                'title' => esc_html__('Coupon expiry date', WCCBEF_NAME),
                'editable' => true,
                'content_type' => 'date',
                'background_color' => '#fff',
                'text_color' => '#444',
